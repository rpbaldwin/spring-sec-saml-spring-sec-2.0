...
public class ExpiringUsernameAuthenticationToken extends UsernamePasswordAuthenticationToken {
     ...
     */
    public ExpiringUsernameAuthenticationToken(Date tokenExpiration, Object principal, Object credentials, GrantedAuthority[] authorities) {//Collection<? extends GrantedAuthority> authorities) {
