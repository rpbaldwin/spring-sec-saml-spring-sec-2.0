...
public class SAMLProcessingFilter extends AbstractProcessingFilter {
    ...
    /**
     * In case the login attribute is not present it is presumed that the call
     * is made from the remote IDP and contains a SAML assertion which is
    ...
    /**
     * Use setAuthenticationSuccessHandler method and pass a custom handler
     * instead.
     * <p/>
     * Creates a new successHandler and sets default URL for redirect after
     * login. In case user requests a specific page which caused the login
     * process initialization the original page will be reused. Any existing
    ...
    /**
     * Sets entity responsible for populating local entity context data. Must be
     * set.
     *
